...
public class CycleServiceTest {
    ...
    public static final Integer TOKEN_LIMIT = 5;
    ...
    public void runSimpleFlowFullCycleTest() throws JAXBException {
        Document document = importer.importPflow("simple_flow.pflow");
    ...
    public void runInhibitorCycleTest() throws JAXBException {
        Document document = importer.importPflow("inhibitor.pflow");
    ...
    public void runResetCycleTest() throws JAXBException {
        Document document = importer.importPflow("reset.pflow");
    ...
    @Test
    public void runConflictTest() throws JAXBException {
        Document document = importer.importPflow("simple_conflict.pflow");
        Integer totalCycles = cycleService.getCyclesQuantityToFinish(document);
        Assert.assertEquals(Integer.valueOf(1), totalCycles);
